...
export default function Home({ navigation }) {
    ...
    return (
        <Center mt={200}>
            ...
            <Pressable rounded={8} shadow={3} mb={3} p={3} bg="#FF5555"><Text bold style={{ color: 'white', width: 350, textAlign: 'center' }} onPress={() => navigation.navigate("Login")}>Login</Text></Pressable>
            <Pressable rounded={8} shadow={3} p={3} bg="coolGray.400"><Text bold style={{ color: 'white', width: 350, textAlign: 'center' }} onPress={() => navigation.navigate("Register")}>Register</Text></Pressable>
        </Center >
    )
